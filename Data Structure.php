...
<h1 style="color: red">DS: Data Structure and Code: 2110003</h1>
<br>
<h1>GTU Course pdf:<A href="ds course.pdf">Data Structure Course</A></h1><br>
<h1>Material in Pdf and Ppt:<br>
<form class="form-horizontal" action="ds_code.php" method="POST">
	<div class="form-group">
    
    <div class="col-sm-6">
    	<label class="radio-inline" style="margin-left: 40px"><input type="radio" name="course" value="DSPDF"  required>PDF</label><br>
      <label class="radio-inline" style="margin-left: 40px"><input type="radio" name="course" value="DSPPT" required>PPT</label><br>
	  </div>
</div>
	<div class="form-group"> 
