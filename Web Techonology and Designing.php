...
<form class="form-horizontal" action="wtd_code.php" method="POST">
	<div class="form-group">
    
    <div class="col-sm-6">
    	<label class="radio-inline" style="margin-left: 40px"><input type="radio" name="course" value="WTPDF"  required>PDF</label><br>
    	<label class="radio-inline" style="margin-left: 40px"><input type="radio" name="course" value="WTPPT"  required>PPT</label><br>
