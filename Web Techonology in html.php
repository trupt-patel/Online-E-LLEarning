...
<h1>HTML Material in Pdf :<br>
<form class="form-horizontal" action="wth_code.php" method="POST">
	<div class="form-group">
    
    <div class="col-sm-6">
    	<label class="radio-inline" style="margin-left: 40px"><input type="radio" name="course" value="HTMLPDF"  required>PDF</label><br>
       </div>
</div>
	<div class="form-group"> 
