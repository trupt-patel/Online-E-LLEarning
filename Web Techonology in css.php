...
<form class="form-horizontal" action="wtc_code.php" method="POST">
	<div class="form-group">
    
    <div class="col-sm-6">
    	<label class="radio-inline" style="margin-left: 40px"><input type="radio" name="course" value="CSSPDF"  required>PDF</label><br>
       </div>
</div>
	<div class="form-group"> 
