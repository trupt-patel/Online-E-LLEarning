...
<h1>Material in Ppt:<br>
	<a href="Basics.ppt" style="margin-left: 25px">1) Basics</a><br>
	<a href="Variable and Method.ppt" style="margin-left: 25px">2) Variable and Method</a><br>
	<a href="Control Statement.ppt" style="margin-left: 25px">3) Control Statement</a><br>
	<a href="Class.ppt" style="margin-left: 25px">4) Class</a><br>
	<a href="Inheritance.ppt" style="margin-left: 25px">5) Inheritance</a><br>
	<a href="Interface & Package.ppt" style="margin-left: 25px">6) Interface & Package</a><br>
	<a href="Exception.ppt" style="margin-left: 25px">7) Exception</a>
</h1>
</text>
</body>
</html>