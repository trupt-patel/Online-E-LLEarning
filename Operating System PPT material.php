...
<h1>Material in Ppt :<br>
	<a href="Thread.ppsx" style="margin-left: 25px">1) Thread</a><br>
	<a href="Deadlocks.ppsx" style="margin-left: 25px">2) Deadlocks </a><br>
	<a href="Memory Management.ppsw" style="margin-left: 25px">3) Memory Management</a><br>
	<a href="Page Replacement Algo.pps" style="margin-left: 25px">4) Page Replacement Algorithm</a><br>
	<a href="IO Management.pps" style="margin-left: 25px">5) IO Management</a><br>
</h1>
</text>
</body>
</html>
