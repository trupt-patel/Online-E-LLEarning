...
<form class="form-horizontal" action="se_Code.php" method="POST">
	<div class="form-group">
    <div class="col-sm-6">
    	<label class="radio-inline" style="margin-left: 40px"><input type="radio" name="course" value="SEPDF"  required>PDF</label><br>
    	<label class="radio-inline" style="margin-left: 40px"><input type="radio" name="course" value="SEPPT"  required>PPT</label><br>
       </div>
</div>
	<div class="form-group"> 
