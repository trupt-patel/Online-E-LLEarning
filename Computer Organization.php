...
<br>
<h1>GTU Course pdf:<A href="co course.pdf">Computer Oganization Course</A></h1><br>
<h1>Material in Pdf and Ppt:<br>
<form class="form-horizontal" action="co_code.php" method="POST">
	<div class="form-group">
    
    <div class="col-sm-6">
    	<label class="radio-inline" style="margin-left: 40px"><input type="radio" name="course" value="COPDF"  required>PDF</label><br>
      <label class="radio-inline" style="margin-left: 40px"><input type="radio" name="course" value="COPPT" required>PPT</label><br>
	  </div>
</div>
	<div class="form-group"> 
