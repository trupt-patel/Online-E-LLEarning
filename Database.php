...
<h1 style="color: red">DBMS: DataBase Management System and Code: 3130703</h1>
<br>
<h1>GTU Course pdf:<A href="dbms course.pdf">DataBase Management  Course</A></h1><br>
<h1>Material in Pdf and Ppt:<br>
<form class="form-horizontal" action="db_code.php" method="POST">
	<div class="form-group">
    
    <div class="col-sm-6">
    	<label class="radio-inline" style="margin-left: 40px"><input type="radio" name="course" value="DBMSPDF"  required>PDF</label><br>
      <label class="radio-inline" style="margin-left: 40px"><input type="radio" name="course" value="DBMSPPT" required>PPT</label><br>
	  </div>
</div>
	<div class="form-group"> 
