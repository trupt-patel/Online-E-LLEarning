...
<h1>Material in Pdf and Ppt and video:<br>
<form class="form-horizontal" action="ada_code.php" method="POST">
	<div class="form-group">
    
    <div class="col-sm-6">
    	<label class="radio-inline" style="margin-left: 40px"><input type="radio" name="course" value="ADAPDF"  required>PDF</label><br>
      <label class="radio-inline" style="margin-left: 40px"><input type="radio" name="course" value="ADAPPT" required>PPT</label><br>
       <label class="radio-inline" style="margin-left: 40px"><input type="radio" name="course" value="MP" required>VIDEO</label><br>
	  </div>
</div>
	<div class="form-group"> 
