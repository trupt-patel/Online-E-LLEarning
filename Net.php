...
<form class="form-horizontal" action="net_code.php" method="POST">
	<div class="form-group">
    <div class="col-sm-6">
    	<label class="radio-inline" style="margin-left: 40px"><input type="radio" name="course" value="NEPDF"  required>PDF</label><br>
    	<label class="radio-inline" style="margin-left: 40px"><input type="radio" name="course" value="NEPPT"  required>PPT</label><br>
       </div>
</div>
	<div class="form-group"> 
