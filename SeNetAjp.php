...
<form class="form-horizontal" action="re_code.php" method="POST">
<div class="form-group">
    <label class="control-label col-sm-2" for="lastname">Choose Course:</label>
    <div class="col-sm-6">
    	<label class="radio-inline"><input type="radio" name="course" value="SE" required>SE</label><br>
	      <label class="radio-inline"><input type="radio" name="course" value="NET" required>NET</label><br>
	      <label class="radio-inline"><input type="radio" name="course" value="AJP" required>AJP</label>
    </div>
    <br>
    <div class="form-group"> 
