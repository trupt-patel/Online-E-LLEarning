...
<h1>Material in Pdf and Ppt and EBOOK:<br>
<form class="form-horizontal" action="java_code.php" method="POST">
	<div class="form-group">
    
    <div class="col-sm-6">
    	<label class="radio-inline" style="margin-left: 40px"><input type="radio" name="course" value="PDF"  required>PDF</label><br>
      <label class="radio-inline" style="margin-left: 40px"><input type="radio" name="course" value="PPT" required>PPT</label><br>
       <label class="radio-inline" style="margin-left: 40px"><input type="radio" name="course" value="EBOOK" required>EBOOK</label><br>
	  </div>
</div>
	<div class="form-group"> 
